...
public class BytecodeHelper {
	...
	public static AbstractInsnNode[] getPrimitivesArgumentConverter(Class<?> type) {
		...
		if(classType != null) {
			return new AbstractInsnNode[]{new TypeInsnNode(Opcodes.CHECKCAST, classType), new MethodInsnNode(Opcodes.INVOKEVIRTUAL, classType, convertMethod, convertMethodType, false)};
		}
		return null;
	}
	...
	public static AbstractInsnNode getPrimitivesReturnConverter(Class<?> type) {
		...
		if(classType != null) {
			return new MethodInsnNode(Opcodes.INVOKESTATIC, classType, convertMethod, convertMethodType, false);
		}
		return null;
	}
}